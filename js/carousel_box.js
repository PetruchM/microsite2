...
function slideSecondCard() {
  ...
  button1.setAttribute('aria-pressed', String(rectangle2.classList.contains('info_active1')));
...
function slideThirdCard() {
  ...
  button2.setAttribute('aria-pressed', String(rectangle3.classList.contains('info_active2')));
